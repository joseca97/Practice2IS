 ...
 */
public class MazeProblemMDP extends MDPLearningProblem implements ProblemVisualizable{
	...
	public static void main(String[] args) {
		MazeProblemMDP mazeProblem = new MazeProblemMDP(15, 5);
		...
		System.out.println(mazeProblem.getTransitionModel(currentState, MazeAction.UP));

...
/** 
*  This algorithm is a basic/demo one. The policy consists of choosing actions randomly.
*/
public class RandomAlgorithm extends LearningAlgorithm{
	...
	protected void learnPolicy() {
		...
		for (State state: states){	
			...
			int selActionIdx = Utils.randGen.nextInt(possibleActions.size());
			// Assigns the corresponding action to the state.
			policy.setAction(state, possibleActions.get(selActionIdx));
		}
	}
